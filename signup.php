...
if (isset($_POST['register'])) {
    ...
    if ($res !== false) {
        if (mysqli_num_rows($res) > 0) {
            ...
            if ($pass === $cpass) {
                ...
                if ($result) {
                    ...
                    echo "<div class='message'><p>An error occurred while registering. Please try again later.</p></div><br>";
        ...
        echo "<div class='message'><p>An error occurred while checking email availability. Please try again later.</p></div><br>";
        echo "<a href='signup.php'><button class='btn'>Go Back</button></a>";
    }
} else {
?>
